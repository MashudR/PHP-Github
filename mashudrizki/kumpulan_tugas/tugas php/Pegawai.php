...
class Pegawai{
    ...
    static $jml = 0;
    const PT = 'PT. Gabut Jaya Bahagia';
    ...
    public function setGapok(){
        switch ($this->jabatan) {
            ...
            case 'Assisten Manager': $gapok = 10000000; break;
    ...
    public function bersih(){
        $gasih = $this->setGator() - $this->setZakatProfesi();
        return $gasih;
    }
    public function mencetak(){
        ...
        echo '<br/>Gaji Bersih: Rp. '.number_format($this->bersih(), 0, ',', '.');
        echo '<hr/>';
    }
}